...
def test_download_manga_helper_function(parser):
    ...
    expected_path = "/tmp/cool_mo_deep/cool_mo_deep_chapter_1_1.pdf"
    expected_path2 = "/tmp/cool_mo_deep/cool_mo_deep_chapter_2_2.pdf"
    assert os.path.exists(expected_path)
...
def test_download_manga_helper_function_preferred_name(parser):
    ...
    expected_path = "/tmp/dragon-ball/dragon-ball_chapter_1_1.pdf"
    expected_path2 = "/tmp/dragon-ball/dragon-ball_chapter_2_2.pdf"
    assert os.path.exists(expected_path)
    assert os.path.exists(expected_path2)
